            ...
            <div class="col-xs-12">
              <!-- general form elements -->
                <div class="box box-primary">
                    ...
                    <form role="form" id="editDocument" action="<?php echo base_url() ?>editDocument" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="<?= $id ?>" name="documentId" id="documentId"/>
                                        <input type="hidden" name="fileIDs" id="fileIDs" value="<?= implode(",", $arrDocumentIDs); ?>" />
                                    </div>
                            </div>
                            <div class="col-md-12">
