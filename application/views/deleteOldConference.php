...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Add / Delete Conference</small>
        </h1>
    </section>
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="editConference" action="<?php echo base_url() ?>editConference" method="post" role="form">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control"
                                               value="Deactivated"
                                               id="cstatus" name="cstatus" maxlength="50">
                                        <input type="hidden" class="form-control required"
                                               value="<?php echo $description; ?>"
                                               id="description" name="description" maxlength="50">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-footer">
                            <input type="submit" class="btn btn-primary" value="Please confirm delete conference."/>
                        </div>
                    </form>
                </div>
            </div>
