          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <form action="#" method="post">
                ...
                <div>
                  <textarea class="textarea" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px;" placeholder="Message"></textarea><input type="hidden" name="_wysihtml5_mode" value="1">
                </div>
              </form>
            </div>
        ...
        <section class="col-lg-5 connectedSortable ui-sortable">
          ...
          <div class="box box-solid bg-teal-gradient">
            ...
            <div class="box-body border-radius-none">
              <div class="chart" id="line-chart" style="height: 250px; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></div>
            </div>
            <!-- /.box-body -->
            <div class="box-footer no-border">
              <div class="row">
